...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "api",
      testIgnore: [/worker-lifecycle\.spec\.ts/, /[\\/]feature-[^\\/]*\.spec\.ts$/, /landing\.spec\.ts/, /projects-ui\.spec\.ts/, /project-import-ui\.spec\.ts/, /resources-ui\.spec\.ts/, /command-palette-ui\.spec\.ts/],
    },
    ...
    {
      name: "browser",
      testMatch: [/landing\.spec\.ts/, /projects-ui\.spec\.ts/, /project-import-ui\.spec\.ts/, /resources-ui\.spec\.ts/, /command-palette-ui\.spec\.ts/],
      fullyParallel: false,
